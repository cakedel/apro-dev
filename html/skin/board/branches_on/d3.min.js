...
(function (t, n) {
      ...
      (M = M.merge(M.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000"))),
        ...
        (E = E.merge(
          S.append("text")
            ...
            .attr(r, d * g)
            .attr(v, 0.5)
            .attr("dy", t === xf ? "0em" : t === wf ? "0.71em" : "0.32em")
        )),
        e !== w &&
          ((M = M.transition(e)),
          (T = T.transition(e)),
        ...
        k.remove(),
        M.attr("d", t === Mf || t == bf ? "M" + d * h + "," + m + "H0.5V" + x + "H" + d * h : "M" + m + "," + d * h + "V0.5H" + x + "V" + d * h),
        ...
        w
          ...
          .attr("text-anchor", t === bf ? "start" : t === Mf ? "end" : "middle"),
        w.each(function () {
          this.__axis = b;
        });
    }
      ...
      if (c)
        for (var f = 0, l = c.length; f < l; ++f)
          if ((a = c[f]).type === t.type && a.name === t.name)
            return (
              this.removeEventListener(a.type, a.listener, a.capture), this.addEventListener(a.type, (a.listener = s), (a.capture = e)), void (a.value = n)
            );
  ...
  function lt(t, n, e) {
    ...
    i
      ? (i = new i(n, e))
      : ((i = r.document.createEvent("Event")), e ? (i.initEvent(n, e.bubbles, e.cancelable), (i.detail = e.detail)) : i.initEvent(n, !1, !1)),
      t.dispatchEvent(i);
  }
  function ht(t, n) {
    return function () {
  ...
  function Tt(t) {
    ...
    return (
      ...
      (n = Ll.exec(t))
        ? ((n = parseInt(n[1], 16)), new At(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1))
        : (n = Rl.exec(t))
        ? kt(parseInt(n[1], 16))
        : (n = ql.exec(t))
  ...
  function zt(t) {
    ...
    return (
      a
        ? ((u = n === o ? (e - r) / a + 6 * (e < r) : e === o ? (r - n) / a + 2 : (n - e) / a + 4), (a /= c < 0.5 ? o + i : 2 - o - i), (u *= 60))
        : (a = c > 0 && c < 1 ? 0 : u),
  ...
  function qt(t) {
    ...
    var e = Yt(t.r),
      r = Yt(t.g),
      i = Yt(t.b),
      o = Ot((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / Hl),
      u = Ot((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Xl);
    return new Dt(116 * u - 16, 500 * (o - u), 200 * (u - Ot((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / Vl)), t.opacity);
  }
  function Ut(t, n, e, r) {
  ...
  function rn(t) {
    return "none" === t
      ? Nh
      : (oh || ((oh = document.createElement("DIV")), (uh = document.documentElement), (ah = document.defaultView)),
  ...
  function on(t) {
    return null == t
      ...
      : (ch || (ch = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        ...
        (t = ch.transform.baseVal.consolidate()) ? ((t = t.matrix), Eh(t.a, t.b, t.c, t.d, t.e, t.f)) : Nh);
  }
  function un(t, n, e, r) {
    function i(t) {
    ...
    function u(t, n, e, o) {
      t !== n
        ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: mh(t, n) }))
        : n && e.push(i(e) + "rotate(" + n + r);
    }
    function a(t, n, e, o) {
      t !== n ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: mh(t, n) }) : n && e.push(i(e) + "skewX(" + n + r);
    }
  ...
  function bn() {
    for (var t, n, e = sh, r = 1 / 0; e; )
      e._call ? (r > e._time && (r = e._time), (t = e), (e = e._next)) : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (sh = n)));
    (fh = t), wn(r);
  }
  function wn(t) {
    if (!Ih) {
    ...
    function i(r) {
      ...
      for (s in c)
        if (((h = c[s]), h.name === e.name)) {
          ...
          h.state === rp
            ? ((h.state = op), h.timer.stop(), h.on.call("interrupt", t, t.__data__, h.index, h.group), delete c[s])
      ...
      if (
        ...
        for (e.state = ep, a = new Array((l = e.tween.length)), s = 0, f = -1; s < l; ++s)
          (h = e.tween[s].value.call(t, t.__data__, e.index, e.group)) && (a[++f] = h);
        a.length = f + 1;
      }
    }
    function o(n) {
      for (var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u), (e.state = ip), 1), i = -1, o = a.length; ++i < o; )
        a[i].call(null, r);
  ...
  function qn(t, n, e) {
    ...
    return function () {
      ...
      return null == a
        ...
        : ((u = this.getAttributeNS(t.space, t.local)), u === a ? null : u === r && a === i ? o : (o = n((r = u), (i = a))));
    };
  }
  function Un(t, n) {
    function e() {
    ...
    function u() {
      ...
      function o() {
        ...
        switch (((m = O[0] - D[0]), (x = O[1] - D[1]), S)) {
          ...
          case ad:
            ...
            break;
          case cd:
            N && ((h = Math.max(P, Math.min(R, l - m * N))), (_ = Math.max(P, Math.min(R, v + m * N)))),
              E && ((d = Math.max(L, Math.min(q, p - x * E))), (y = Math.max(L, Math.min(q, g + x * E))));
        }
        _ < h && ((N *= -1), (t = l), (l = v), (v = t), (t = h), (h = _), (_ = t), k in pd && Y.attr("cursor", hd[(k = pd[k])])),
          y < d && ((E *= -1), (t = p), (p = g), (g = t), (t = d), (d = y), (y = t), k in dd && Y.attr("cursor", hd[(k = dd[k])])),
      ...
      function a() {
        switch (t.event.keyCode) {
          ...
          case 32:
            (S !== ad && S !== cd) ||
              (N < 0 ? (v = _ - m) : N > 0 && (l = h - m), E < 0 ? (g = y - x) : E > 0 && (p = d - x), (S = ud), Y.attr("cursor", hd.selection), o());
            break;
          default:
            return;
        }
      ...
      function s() {
        switch (t.event.keyCode) {
          ...
          case 32:
            S === ud &&
              (t.event.altKey
                ? (N && ((v = _ - m * N), (l = h + m * N)), E && ((g = y - x * E), (p = d + x * E)), (S = cd))
                : (N < 0 ? (v = _) : N > 0 && (l = h), E < 0 ? (g = y) : E > 0 && (p = d), (S = ad)),
              Y.attr("cursor", hd[k]),
              o());
            break;
          default:
  ...
  function qr(t, n) {
    ...
    if (Wv) {
      ...
      f ^ (c * Xv < s && s < c * t)
        ? (u = o[1] * m_) > Hv && (Hv = u)
        : ((s = ((s + 360) % 360) - 180), f ^ (c * Xv < s && s < c * t) ? (u = -o[1] * m_) < Bv && (Bv = u) : (n < Bv && (Bv = n), n > Hv && (Hv = n))),
        f
          ? t < Xv
    ...
    return function (u) {
      ...
      function l() {
        var t = s(),
          n = k && t,
          e = (v = ff(v)).length;
        (n || e) && (u.polygonStart(), n && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), e && sg(v, a, t, o, u), u.polygonEnd()),
          (S = u),
          (v = _ = g = null);
      }
      function h() {
      ...
      function d(o, u) {
        ...
        if ((_ && g.push([o, u]), T)) (y = o), (m = u), (x = a), (T = !1), a && (S.lineStart(), S.point(o, u));
          ...
          ag(c, s, t, n, e, r)
            ? (M || (S.lineStart(), S.point(c[0], c[1])), S.point(s[0], s[1]), a || S.lineEnd(), (k = !1))
    ...
    return {
      ...
      point: function (o, u) {
        var a = o > 0 ? v_ : -v_,
          c = b_(o - e);
        b_(c - v_) < d_
          ? (t.point(e, (r = (r + u) / 2 > 0 ? __ : -__)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), (n = 0))
          : i !== a &&
            c >= v_ &&
            (b_(e - i) < d_ && (e -= i * d_),
            b_(o - a) < d_ && (o -= a * d_),
    ...
    function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
      ...
      if (m > 4 * n && v--) {
        var x = u + h,
          ...
          C = E - i,
          z = y * A - g * C;
        ((z * z) / m > n || b_((g * A + y * C) / m - 0.5) > 0.3 || u * h + a * p + c * d < ry) &&
          (e(r, i, o, u, a, c, N, E, k, (x /= M), (b /= M), w, v, _), _.point(N, E), e(N, E, k, x, b, w, s, f, l, h, p, d, v, _));
      }
    }
    return function (n) {
      function r(e, r) {
  ...
  function no(t) {
    ...
    return (
      ...
      (n.clipExtent = function (t) {
        return arguments.length
          ? ((N = null == t ? ((S = l = h = p = null), kg) : si((S = +t[0][0]), (l = +t[0][1]), (h = +t[1][0]), (p = +t[1][1]))), o())
          : null == S
          ? null
          : [
              [S, l],
      ...
      (n.rotate = function (t) {
        return arguments.length
          ? ((b = (t[0] % 360) * x_), (w = (t[1] % 360) * x_), (M = t.length > 2 ? (t[2] % 360) * x_ : 0), i())
          : [b * m_, w * m_, M * m_];
      }),
  ...
  function so(t) {
    ...
    return (
      ...
      (o.clipExtent = function (t) {
        return arguments.length
          ? (null == t ? (f = e = r = i = null) : ((f = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1])), n())
          : null == f
          ? null
          : [
              [f, e],
  ...
  function Ao(t, n) {
    ...
    for (null == n && (n = zo); (e = s.pop()); )
      if ((c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length)))
        for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push((r = e.children[o] = new Ro(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
      ...
      (i = u._),
        ...
        e && Uo(e, i)
          ...
          : (o ? ((t.tail = o), (o.next = null)) : (t.head = t.tail = null),
            ...
            (e = Do(t, n)),
            n.pop(),
            t.head ? ((u.next = t.head), (t.head = u)) : ((u.next = null), (t.head = t.tail = u)),
            (o = t.tail),
            (o.next = r)),
        (u = r);
    return (t.tail = o), e;
  ...
  function Xo(t) {
    ...
    t: for (a = 3; a < i; ++a) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, v += d = r._.r * r._.r, _ += d * r._.x, g += d * r._.y, h = jo(n, (o = _ / v), (u = g / v));
        (r = r.next) !== e;
  ...
  function su(t, n, e, r, i, o) {
    for (var u, a, c, s, f, l, h, p, d, v, _, g = [], y = n.children, m = 0, x = 0, b = y.length, w = n.value; m < b; ) {
      ...
      g.push((u = { value: f, dice: c < s, children: y.slice(m, x) })),
        u.dice ? Iy(u, e, r, i, w ? (r += (s * f) / w) : o) : $y(u, e, r, w ? (e += (c * f) / w) : i, o),
        (w -= f),
        (m = x);
    }
    return g;
  ...
  function vu(t, n) {
    return function (e, r) {
      t._tasks[n] &&
        (--t._active, ++t._ended, (t._tasks[n] = null), null == t._error && (null != e ? _u(t, e) : ((t._data[n] = r), t._waiting ? pu(t) : gu(t))));
    };
  }
  function _u(t, n) {
    var e,
    ...
    function n(t, n) {
      return function (e) {
        ...
        for (e instanceof Date || (e = new Date(+e)); ++a < s; )
          37 === t.charCodeAt(a) &&
            (u.push(t.slice(c, a)),
            null != (i = qx[(r = t.charAt(++a))]) ? (r = t.charAt(++a)) : (i = "e" === r ? " " : "0"),
            (o = n[r]) && (r = o(e, i)),
            u.push(r),
            (c = a + 1));
    ...
    function l(n, e, i, o) {
      if ((null == n && (n = 10), "number" == typeof n)) {
        ...
        a === M.length
          ? ((o = r(e / $x, i / $x, n)), (n = t))
          : a
          ? ((a = M[u / M[a - 1][2] < M[a][2] / u ? a - 1 : a]), (o = a[1]), (n = a[0]))
          : ((o = r(e, i, n)), (n = c));
      }
  ...
  function lc(t, n, e, r, i, o, u) {
    var a = t - e,
      ...
      C = S - _,
      z = N - g;
    return E * E + A * A > C * C + z * z && ((T = S), (k = N)), { cx: T, cy: k, x01: -f, y01: -l, x11: T * (i / b - 1), y11: k * (i / b - 1) };
  }
  function hc(t) {
    this._context = t;
  }
  ...
  function Lc(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (e - t._y1) / (i || (r < 0 && -0)),
      a = (o * i + u * r) / (r + i);
    return (Pc(o) + Pc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) || 0;
  }
  function Rc(t, n) {
    var e = t._x1 - t._x0;
  ...
  function us(t, n, e, r) {
    for (var i, o = Nw.length; o--; )
      (os((i = Nw[o]), t, n, e, r) && is(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > Cw || Math.abs(i[0][1] - i[1][1]) > Cw)) || delete Nw[o];
  }
  function as(t) {
      ...
      if ((o = kw[i])) {
        ...
        for (a = 0, s = c.length; a < s; )
          (p = fs(o, Nw[c[a]])),
            ...
            (l = f[0]),
            (h = f[1]),
            (Math.abs(d - l) > Cw || Math.abs(v - h) > Cw) &&
              (c.splice(
                a,
                0,
                Nw.push(
                  es(
                    ...
                    Math.abs(d - t) < Cw && r - v > Cw
                      ? [t, Math.abs(l - t) < Cw ? h : r]
                      : Math.abs(v - r) < Cw && e - d > Cw
                      ? [Math.abs(h - r) < Cw ? l : e, r]
                      : Math.abs(d - e) < Cw && v - n > Cw
                      ? [e, Math.abs(l - e) < Cw ? h : n]
                      : Math.abs(v - n) < Cw && d - t > Cw
                      ? [Math.abs(h - n) < Cw ? l : t, n]
                      : null
                  )
                ) - 1
              ),
  ...
  function ks(t, n) {
    ...
    for (Nw = [], kw = new Array(t.length), Tw = new Gc(), Sw = new Gc(); ; )
      if (((i = Mw), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x)))) (o[0] === e && o[1] === r) || (xs(o), (e = o[0]), (r = o[1])), (o = t.pop());
      else {
        if (!i) break;
        ms(i.arc);
      }
  ...
  var Ls = function (t, n) {
    ...
    of = function (t, n, e) {
      return (t = $s.call(t, Ys).sort(Ls)), Math.ceil((e - n) / (2 * (rf(t, 0.75) - rf(t, 0.25)) * Math.pow(t.length, -1 / 3)));
    },
    uf = function (t, n, e) {
  ...
  var Sf = "http://www.w3.org/1999/xhtml",
    ...
    Ef = function (t) {
      var n = (t += ""),
        e = n.indexOf(":");
      return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), Nf.hasOwnProperty(n) ? { space: Nf[n], local: t } : t;
    },
    Af = function (t) {
      var n = Ef(t);
  ...
  var $f = function (t) {
    ...
    cl = function (t, n, e) {
      ...
      return arguments.length > 1
        ? this.each((null == n ? Y : "function" == typeof n ? j : B)(t, n, null == e ? "" : e))
        : al((r = this.node()))
  ...
  var El = function () {
      ...
      function c(e, r, i, o, u) {
        var a,
          ...
          l = _.copy();
        if (
          E(new yt(n, "beforestart", a, e, g, f[0], f[1], 0, 0, l), function () {
  ...
  Al(Mt, Tt, {
    ...
    Al(
      ...
      wt(Mt, {
        brighter: function (t) {
          return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new At(this.r * t, this.g * t, this.b * t, this.opacity);
        },
        darker: function (t) {
          return (t = null == t ? 0.7 : Math.pow(0.7, t)), new At(this.r * t, this.g * t, this.b * t, this.opacity);
        },
        rgb: function () {
          return this;
        },
    ...
    Al(
      ...
      wt(Mt, {
        brighter: function (t) {
          return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Lt(this.h, this.s, this.l * t, this.opacity);
        },
        darker: function (t) {
    ...
    wt(Mt, {
      ...
      rgb: function () {
        ...
        return (
          ...
          (e = Vl * Ft(e)),
          new At(
            It(3.2404542 * n - 1.5371385 * t - 0.4985314 * e),
            It(-0.969266 * n + 1.8760108 * t + 0.041556 * e),
            It(0.0556434 * n - 0.2040259 * t + 1.0572252 * e),
            this.opacity
          )
        );
      },
  ...
  Al(
    ...
    wt(Mt, {
      brighter: function (t) {
        return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new $t(this.h, this.s, this.l * t, this.opacity);
      },
      darker: function (t) {
  ...
  var oh,
    ...
    Mh = function (t, n) {
      ...
      for (t += "", n += ""; (e = bh.exec(t)) && (r = wh.exec(n)); )
        (i = r.index) > o && ((i = n.slice(o, i)), a[u] ? (a[u] += i) : (a[++u] = i)),
          (e = e[0]) === (r = r[0]) ? (a[u] ? (a[u] += r) : (a[++u] = r)) : ((a[++u] = null), c.push({ i: u, x: mh(e, r) })),
          (o = wh.lastIndex);
      return (
    ...
    Sh = 180 / Math.PI,
    Nh = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 },
    Eh = function (t, n, e, r, i, o) {
      ...
      return (
        ...
        { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Sh, skewX: Math.atan(c) * Sh, scaleX: u, scaleY: a }
      );
    },
    Ah = un(rn, "px, ", "px)", "deg)"),
    Ch = un(on, ", ", ")", ")"),
  ...
  _n.prototype = gn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? dn() : +e) + (null == n ? 0 : +n)),
        this._next || fh === this || (fh ? (fh._next = this) : (sh = this), (fh = this)),
        (this._call = t),
        (this._time = e),
        wn();
    },
  ...
  var Zh = function (t, n, e) {
    ...
    up = function (t, n, e, r, i, o) {
      ...
      Sn(t, e, { name: n, index: r, group: i, on: Jh, tween: Qh, time: o.time, delay: o.delay, duration: o.duration, ease: o.ease, timer: null, state: Kh });
    },
    ap = function (t, n) {
      var e,
        r,
      ...
      if (o) {
        ...
        for (i in o)
          (e = o[i]).name === n
            ? ((r = e.state > np && e.state < ip), (e.state = op), e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i])
            : (u = !1);
    ...
    lp = function (t, n) {
      ...
      return this.attrTween(
        t,
        "function" == typeof n ? (e.local ? qn : Rn)(e, r, An(this, "attr." + t, n)) : null == n ? (e.local ? zn : Cn)(e) : (e.local ? Ln : Pn)(e, r, n + "")
      );
    },
    hp = function (t, n) {
      var e = "attr." + t;
    ...
    xp = function (t) {
      ...
      for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
        for (var a, c, s = r[u], f = s.length, l = (o[u] = new Array(f)), h = 0; h < f; ++h)
          (a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), (l[h] = c), up(l[h], n, e, h, l, kn(a, e)));
    ...
    Tp = function (t, n, e) {
      ...
      return null == n
        ? this.styleTween(t, Vn(t, r)).on("end.style." + t, $n(t))
        : this.styleTween(t, "function" == typeof n ? Zn(t, r, An(this, "style." + t, n)) : Wn(t, r, n + ""), e);
    },
    kp = function (t, n, e) {
      var r = "style." + (t += "");
  ...
  var Cp = (function t(n) {
    ...
    Qp = { time: null, delay: 0, duration: 250, ease: ce },
    Kp = function (t) {
      var n, e;
      t instanceof Kn ? ((n = t._id), (t = t._name)) : ((n = ne()), ((e = Qp).time = dn()), (t = null == t ? null : t + ""));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) (u = a[s]) && up(u, t, n, s, a, e || be(u, n));
  ...
  var td = [null],
    ...
    _d = { overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1 },
    gd = function () {
      return ze(ld);
    },
    yd = Math.cos,
    ...
    arc: function (t, n, e, r, i, o) {
      ...
      null === this._x1 ? (this._ += "M" + c + "," + s) : (Math.abs(this._x1 - c) > 1e-6 || Math.abs(this._y1 - s) > 1e-6) && (this._ += "L" + c + "," + s),
        e &&
          ...
          l > Ad
            ? (this._ +=
                "A" + e + "," + e + ",0,1," + f + "," + (t - u) + "," + (n - a) + "A" + e + "," + e + ",0,1," + f + "," + (this._x1 = c) + "," + (this._y1 = s))
            : l > 1e-6 &&
              (this._ += "A" + e + "," + e + ",0," + +(l >= Nd) + "," + f + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))));
    },
  ...
  var Ld = function (t) {
    ...
    nv = function (t, n, e) {
      var r,
        ...
        d = [],
        v = this._root;
      for (v && d.push(new tv(v, f, l, h, p)), null == e ? (e = 1 / 0) : ((f = t - e), (l = n - e), (h = t + e), (p = n + e), (e *= e)); (c = d.pop()); )
        if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l))
          if (v.length) {
            var _ = (i + u) / 2,
              g = (o + a) / 2;
            d.push(new tv(v[3], _, g, u, a), new tv(v[2], i, g, _, a), new tv(v[1], _, o, u, g), new tv(v[0], i, o, _, g)),
    ...
    ov = function (t) {
      var n,
        ...
        a = [],
        c = this._root;
      for (c && a.push(new tv(c, this._x0, this._y0, this._x1, this._y1)); (n = a.pop()); )
  ...
  (sv.copy = function () {
    ...
    for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
      for (var i = 0; i < 4; ++i) (n = r.source[i]) && (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = ir(n)));
    return e;
  }),
    (sv.add = Gd),
    (sv.addAll = Qe),
  ...
  var fv,
    lv = function (t) {
      function n() {
        ...
        for (var n, r, c, s, f, l, h, p = i.length, d = 0; d < a; ++d)
          for (r = er(i, or, ur).visitAfter(e), n = 0; n < p; ++n) (c = i[n]), (l = o[c.index]), (h = l * l), (s = c.x + c.vx), (f = c.y + c.vy), r.visit(t);
      }
      function e(t) {
      ...
      var i,
        ...
        a = 1;
      return (
        "function" != typeof t && (t = Wd(null == t ? 1 : +t)),
    ...
    gv = function (t) {
      ...
      var r,
        ...
        u = Wd(0.1);
      return (
        "function" != typeof t && (t = Wd(null == t ? 0 : +t)),
        (n.initialize = function (t) {
          (r = t), e();
        }),
        (n.strength = function (t) {
    ...
    bv = function (t, n) {
      return function (e, r) {
        for (
          ...
          i > 0 && a > 0 && (c + a + 1 > r && (a = Math.max(1, r - c)), o.push(e.substring((i -= a), i + a)), !((c += a + 1) > r));
    ...
    zv = function (t) {
      function n(t) {
        ...
        var e = t.fill,
          ...
          y = !d || /[defgprs%]/.test(d);
        return (
          (p = null == p ? (d ? 6 : 12) : /[gprs]/.test(d) ? Math.max(1, Math.min(21, p)) : Math.max(0, Math.min(20, p))),
          (n.toString = function () {
            return t + "";
          }),
          n
  ...
  var Uv,
    ...
    Y_ = {
      ...
      polygonEnd: function () {
        O_.polygonEnd(),
          ...
          (Y_.lineStart = Ur),
          (Y_.lineEnd = Dr),
          U_ < 0 ? ((Yv = -(jv = 180)), (Bv = -(Hv = 90))) : I_ > d_ ? (Hv = 90) : I_ < -d_ && (Bv = -90),
          (Gv[0] = Yv),
          (Gv[1] = jv);
      },
    },
    B_ = function (t) {
      ...
      if (((Hv = jv = -(Yv = Bv = 1 / 0)), (Zv = []), q_(t, Y_), (e = Zv.length))) {
        for (Zv.sort(Br), n = 1, r = Zv[0], o = [r]; n < e; ++n)
          (i = Zv[n]),
            jr(r, i[0]) || jr(r, i[1]) ? (Yr(r[0], i[1]) > Yr(r[0], r[1]) && (r[1] = i[1]), Yr(i[0], r[1]) > Yr(r[0], r[1]) && (r[0] = i[0])) : o.push((r = i));
    ...
    H_ = function (t) {
      ...
      var n = o_,
        ...
        r = a_,
        i = n * n + e * e + r * r;
      return i < 1e-12 && ((n = e_), (e = r_), (r = i_), Qv < d_ && ((n = Kv), (e = t_), (r = n_)), (i = n * n + e * e + r * r) < 1e-12)
        ? [NaN, NaN]
        : [M_(e, n) * m_, gr(r / z_(i)) * m_];
    },
    X_ = function (t) {
      return function () {
        return t;
  ...
  var $_,
    ...
    ig = function (t) {
      ...
      return (
        (t = ni(t[0] * x_, t[1] * x_, t.length > 2 ? t[2] * x_ : 0)),
        (n.invert = function (n) {
    ...
    og = function () {
      ...
      function n() {
        ...
        return (e = []), (r = ni(-t[0] * x_, -t[1] * x_, 0).invert), oi(a, n, c, 1), (t = { type: "Polygon", coordinates: [e] }), (e = r = null), t;
      }
      var e,
        r,
        i = X_([0, 0]),
    ...
    dg = function (t, n) {
      ...
      for (var a = 0, c = t.length; a < c; ++a)
        if ((f = (s = t[a]).length))
          for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + g_, d = A_(p), v = T_(p), _ = 0; _ < f; ++_, h = y, d = x, v = b, l = g) {
            var g = s[_],
              y = g[0],
              m = g[1] / 2 + g_,
              x = A_(m),
    ...
    vg = qv(),
    _g = { sphere: mr, point: mr, lineStart: fi, lineEnd: mr, polygonStart: mr, polygonEnd: mr },
    gg = function (t) {
      return vg.reset(), q_(t, _g), +vg;
    },
    yg = [null, null],
    mg = { type: "LineString", coordinates: yg },
    xg = function (t, n) {
    ...
    ty = function (t, n) {
      ...
      function o(t, n, e) {
        ...
        if (!(y < 0)) {
          ...
          if (
            (!N && k < T && ((b = T), (T = k), (k = b)),
            E ? (N ? (T + k > 0) ^ (x[1] < (b_(x[0] - w) < d_ ? T : k)) : T <= x[1] && x[1] <= k) : (S > v_) ^ (w <= x[0] && x[0] <= M))
          ) {
            var A = Pr(v, (-_ + m) / g);
  ...
  var ey = 16,
    ...
    ay = function () {
      return uy().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
    },
    cy = function () {
      function t(t) {
        var n = t[0],
        ...
        (t.translate = function (t) {
          ...
          return (
            ...
            (o = s
              ...
              .clipExtent([
                [r - 0.425 * e + d_, a + 0.12 * e + d_],
                [r - 0.214 * e - d_, a + 0.234 * e - d_],
              ])
              .stream(l)),
            (u = f
              .translate([r - 0.205 * e, a + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + d_, a + 0.166 * e + d_],
                [r - 0.115 * e - d_, a + 0.234 * e - d_],
              ])
              .stream(l)),
            n()
          );
    ...
    yy = function () {
      ...
      return (u = {
        ...
        clipExtent: function (i) {
          return arguments.length
            ? ((d = null == i ? ((p = n = e = r = null), kg) : si((p = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))), t())
            : null == p
            ? null
            : [
                [p, n],
    ...
    Oy = function () {
      function t(t) {
        return (
          ...
          (t.y = r / 2),
          n
            ? t.eachBefore(Go(n)).eachAfter(Jo(i, 0.5)).eachBefore(Qo(1))
            : t
                .eachBefore(Go(Zo))
                .eachAfter(Jo(Wo, 1))
  ...
  var Vy = function () {
      ...
      function r(t, n, e) {
        if (n) {
          for (var r, i = t, u = t, a = n, c = i.parent.children[0], s = i.m, f = u.m, l = a.m, h = c.m; (a = ru(a)), (i = eu(i)), a && i; )
            (c = eu(c)),
              (u = ru(u)),
              (u.a = t),
  ...
  var Fx = Date.prototype.toISOString ? Ga : t.utcFormat("%Y-%m-%dT%H:%M:%S.%LZ"),
    ...
    nb = Oh(Vt(300, 0.5, 0), Vt(-240, 0.5, 1)),
    eb = Oh(Vt(-100, 0.75, 0.35), Vt(80, 1.5, 0.8)),
    rb = Oh(Vt(260, 0.75, 0.35), Vt(80, 1.5, 0.8)),
    ib = Vt(),
    ob = function (t) {
      (t < 0 || t > 1) && (t -= Math.floor(t));
      var n = Math.abs(t - 0.5);
      return (ib.h = 360 * t - 100), (ib.s = 1.5 - 1.5 * n), (ib.l = 0.8 - 0.9 * n), ib + "";
    },
    ub = nc(
      Gx(
    ...
    wb = function () {
      function t() {
        ...
        if ((c || (c = t = Re()), l < f && ((s = l), (l = f), (f = s)), l > yb))
          if (d > bb - yb) c.moveTo(l * pb(h), l * _b(h)), c.arc(0, 0, l, h, p, !v), f > yb && (c.moveTo(f * pb(p), f * _b(p)), c.arc(0, 0, f, p, h, v));
          else {
            var _,
              g,
              y = h,
            ...
            if (k > yb) {
              var A = ic((k / f) * _b(T)),
                C = ic((k / l) * _b(T));
              (w -= 2 * A) > yb ? ((A *= v ? 1 : -1), (x += A), (b -= A)) : ((w = 0), (x = b = (h + p) / 2)),
                (M -= 2 * C) > yb ? ((C *= v ? 1 : -1), (y += C), (m -= C)) : ((M = 0), (y = m = (h + p) / 2));
            }
            var z = l * pb(y),
              P = l * _b(y),
              L = f * pb(b),
                ...
                ? ((_ = lc(D, O, z, P, l, E, v)),
                  ...
                  E < S
                    ...
                    : (c.arc(_.cx, _.cy, E, hb(_.y01, _.x01), hb(_.y11, _.x11), !v),
                      c.arc(0, 0, l, hb(_.cy + _.y11, _.cx + _.x11), hb(g.cy + g.y11, g.cx + g.x11), !v),
                  ...
                  ? ((_ = lc(L, R, q, U, f, -N, v)),
                    ...
                    N < S
                      ...
                      : (c.arc(_.cx, _.cy, N, hb(_.y01, _.x01), hb(_.y11, _.x11), !v),
                        c.arc(0, 0, f, hb(_.cy + _.y11, _.cx + _.x11), hb(g.cy + g.y11, g.cx + g.x11), v),
    ...
    Eb = function () {
      function t(t) {
        ...
        for (
          ...
          (c = d[a]), (l = v[c]), (f = _ + (l > 0 ? l * s : 0) + m), (v[c] = { data: t[c], index: a, value: l, startAngle: _, endAngle: f, padAngle: y });
        return v;
      }
      var n = Nb,
        e = Sb,
    ...
    insert: function (t, n) {
      ...
      for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
        (r = e.U),
          e === r.L
            ? ((i = r.R),
              i && i.C ? ((e.C = i.C = !1), (r.C = !0), (t = r)) : (t === e.R && (Qc(this, e), (t = e), (e = t.U)), (e.C = !1), (r.C = !0), Kc(this, r)))
            : ((i = r.L),
              i && i.C ? ((e.C = i.C = !1), (r.C = !0), (t = r)) : (t === e.L && (Kc(this, e), (t = e), (e = t.U)), (e.C = !1), (r.C = !0), Qc(this, r))),
          (e = t.U);
      this._.C = !1;
    },
    remove: function (t) {
      ...
      if (
        ...
        o && u
          ? ((r = e.C),
            ...
            (e.L = o),
            (o.U = e),
            e !== u ? ((i = e.U), (e.U = t.U), (t = e.R), (i.L = t), (e.R = u), (u.U = e)) : ((e.U = i), (i = e), (t = e.R)))
          : ((r = t.C), (t = e)),
        t && (t.U = i),
        !r)
      ) {
    ...
    Uw = function () {
      ...
      return (
        ...
        (n.translateBy = function (t, e, r) {
          n.transform(t, function () {
            return i(
              this.__zoom.translate("function" == typeof e ? e.apply(this, arguments) : e, "function" == typeof r ? r.apply(this, arguments) : r),
