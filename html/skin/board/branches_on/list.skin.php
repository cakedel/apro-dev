...
<!-- 게시판 목록 시작 { -->
<div id="bo_list" style="width:<?php echo $width; ?>" class="width1200 padding_lr">
...
<!-- } 게시판 검색 끝 -->
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="board_btn">관리자</a></li><?php } ?>
    ...
    <div class="tbl_head01 tbl_wrap" style="overflow-x: scroll;">
...
<script>
  ...
  function go_branch(city_do) {
    ...
    //alert(strArr[idx]);
    location.href="./board.php?bo_table=center&sca="+strArr[idx];
  }
